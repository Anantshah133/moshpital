...
const MyProfile = () => {
    const [userData, setUserData] = useState({
        ...
        email: "dev.anantshah@gmail.com",
        phone: "+91 99245-90125",
        address: {
            line1: "301 Rivera towers APT",
            line2: "Adajan, Surat - 395009"
        },
        gender: "Male",
        dob: "2005-03-13",
    });
    ...
    return (
        <div className="max-w-lg flex flex-col gap-2 text-sm">
            ...
            <div className="mt-10">
                {
                    isEdit 
                    ? <button className="border border-primary hover:bg-primary hover:text-white transition-all duration-300 px-8 py-2 rounded-full" onClick={()=>setIsEdit(false)}>Save Information</button>
